...
public class JoinFrame  implements ActionListener {
	...
	JFrame frame = new JFrame("회원가입 페이지");
	...
	//버튼
	JButton yesBtn = new JButton("회원가입");
	JButton eraseBtn = new JButton("종료");
	...
	public JoinFrame() {
	    ...
	    mainJDialog.add(controlPanel);
	    headPanel.setBackground(color); // 패널색 변경
	    mainJDialog.add(headPanel);
	    labelPanel.setBackground(color); // 패널색 변경
	    mainJDialog.add(labelPanel);
	    fieldPanel.setBackground(color); // 패널색 변경
	    mainJDialog.add(fieldPanel);
	    dataPanel.setBackground(color); // 패널색 변경
	    mainJDialog.add(dataPanel);
	    buttonPanel.setBackground(color); // 패널색 변경
	    mainJDialog.add(buttonPanel);
	    mainJDialog.setVisible(false);
